...
public class TeleportController : MonoBehaviour {
	...
	public int speed = 0; /* for joystick movement */
	...
	void Update () {
		...
		if (positionIndicator) {
			...
			/* simple joystick movement... does not work when looking at teleport point. Does not follow track of land (floating head x-y only), does not allow head
			rotation. Speed 5 seems a bit too fast.  Pretty disorientating.   */
